...
When a user returns to continue work on an existing AI-DLC-UML project, present this prompt:

```markdown
**Welcome back! I can see you have an existing AI-DLC-UML project in progress.**
