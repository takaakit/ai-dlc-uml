# AI-DLC-UML Terminology Glossary

## Core Terminology

### Phase vs Stage

**Phase**: One of the three high-level lifecycle phases in AI-DLC-UML
...
- **Design-Code Synchronization**: Detecting and eliminating drift between generated/modified code and construction-phase artifacts (per-unit)
