...
**Purpose**: Explain how AI-DLC-UML adapts detail level to problem complexity
...
**All scenarios create the same artifacts**:
- `application-design.asta`

**Detail level varies by complexity**:

### Simple Scenario (Single Component)
- **application-design.asta**: Basic component description, key methods, simple diagram with essential relationships

### Complex Scenario (Multi-Component System)
- **application-design.asta**: Detailed component responsibilities, all methods with signatures, design patterns, alternatives considered, comprehensive diagram with all relationships, data flows, integration points
