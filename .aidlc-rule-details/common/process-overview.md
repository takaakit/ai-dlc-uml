# AI-DLC-UML Adaptive Workflow Overview
...
• **All other stages are conditional**: Reverse Engineering, User Stories, Application Design, Units Generation, per-unit design stages (Functional Design, NFR Requirements, NFR Design, Infrastructure Design, Design-Code Synchronization)
...
## AI-DLC-UML Three-Phase Workflow:
...
flowchart TD
    ...
    subgraph CONSTRUCTION["🟢 CONSTRUCTION PHASE"]
        ...
        DCS["Design-Code Synchronization<br/><b>CONDITIONAL</b>"]
    ...
    style DCS fill:#FFA726,stroke:#E65100,stroke-width:3px,stroke-dasharray: 5 5,color:#000
...
- Design-Code Synchronization: Detect and eliminate drift between code and construction-phase artifacts (CONDITIONAL, per-unit)
