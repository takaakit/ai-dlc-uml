...
- **ALWAYS** include these mandatory artifacts in the design plan:
  - [ ] Open or create the Astah Pro project `aidlc-docs/inception/application-design.asta`
  - [ ] Create components (class elements stereotyped as <<component>>) with component definitions and high-level responsibilities in the element descriptions
  - [ ] Create component methods with method signatures (business rules detailed later in Functional Design)
  - [ ] Create services (class elements stereotyped as <<service>>) with service definitions and orchestration patterns in the element descriptions
  - [ ] Create component dependencies with communication patterns in the element descriptions
  - [ ] Create UML diagrams illustrating components, services, and their dependencies
...
- Create components (class elements stereotyped as <<component>>) using class elements and their description field with:
  - Component name and purpose
  - Component responsibilities
  - Component interfaces
- Create component methods using method elements and their description field with:
...
- Create services (class elements stereotyped as <<service>>) using class elements and their description field with:
  - Service definitions
  - Service responsibilities
  - Service interactions and orchestration
- Create component dependencies using dependency elements and their description field with:
  - Communication patterns between components
- Create UML diagrams illustrating the structure and behavior of the UML model elements and relationships created above. You may create as many diagrams as needed.
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the application design artifacts (Astah Pro project) at: `aidlc-docs/inception/application-design.asta`
