...
- [ ] Create units (class elements stereotyped as <<unit>>) with unit definitions and responsibilities in the element descriptions
- [ ] Create unit dependencies
- [ ] Document the corresponding stories in the description field of the unit's elements
- [ ] **Greenfield only**: Document code organization strategy in the description field of the unit's elements (see code-generation.md for structure patterns)
- [ ] Create a class diagram illustrating units and their dependencies
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts (Astah Pro project) at: `aidlc-docs/inception/application-design.asta`
...
- All unit artifacts generated in Astah Pro project according to plan:
  - Unit model elements with unit definitions and corresponding stories
  - Unit dependency elements
  - A class diagram illustrating the units and their dependencies
